...
var cljs$core$async$impl$protocols$ReadPort$take_BANG_$dyn_43396 = (function (port,fn1_handler){
...
return cljs$core$async$impl$protocols$ReadPort$take_BANG_$dyn_43396(port,fn1_handler);
}
});
...
var cljs$core$async$impl$protocols$WritePort$put_BANG_$dyn_43403 = (function (port,val,fn1_handler){
var x__4428__auto__ = (((port == null))?null:port);
...
return cljs$core$async$impl$protocols$WritePort$put_BANG_$dyn_43403(port,val,fn1_handler);
}
});
...
var cljs$core$async$impl$protocols$Channel$close_BANG_$dyn_43407 = (function (chan){
...
return cljs$core$async$impl$protocols$Channel$close_BANG_$dyn_43407(chan);
}
});

var cljs$core$async$impl$protocols$Channel$closed_QMARK_$dyn_43413 = (function (chan){
var x__4428__auto__ = (((chan == null))?null:chan);
...
return cljs$core$async$impl$protocols$Channel$closed_QMARK_$dyn_43413(chan);
}
});
...
var cljs$core$async$impl$protocols$Handler$active_QMARK_$dyn_43414 = (function (h){
...
return cljs$core$async$impl$protocols$Handler$active_QMARK_$dyn_43414(h);
}
});

var cljs$core$async$impl$protocols$Handler$blockable_QMARK_$dyn_43416 = (function (h){
var x__4428__auto__ = (((h == null))?null:h);
...
return cljs$core$async$impl$protocols$Handler$blockable_QMARK_$dyn_43416(h);
}
});

var cljs$core$async$impl$protocols$Handler$commit$dyn_43422 = (function (h){
var x__4428__auto__ = (((h == null))?null:h);
...
return cljs$core$async$impl$protocols$Handler$commit$dyn_43422(h);
}
});
...
var cljs$core$async$impl$protocols$Buffer$full_QMARK_$dyn_43431 = (function (b){
...
return cljs$core$async$impl$protocols$Buffer$full_QMARK_$dyn_43431(b);
}
});

var cljs$core$async$impl$protocols$Buffer$remove_BANG_$dyn_43436 = (function (b){
var x__4428__auto__ = (((b == null))?null:b);
...
return cljs$core$async$impl$protocols$Buffer$remove_BANG_$dyn_43436(b);
}
});

var cljs$core$async$impl$protocols$Buffer$add_BANG__STAR_$dyn_43453 = (function (b,itm){
var x__4428__auto__ = (((b == null))?null:b);
...
return cljs$core$async$impl$protocols$Buffer$add_BANG__STAR_$dyn_43453(b,itm);
}
});

var cljs$core$async$impl$protocols$Buffer$close_buf_BANG_$dyn_43463 = (function (b){
var x__4428__auto__ = (((b == null))?null:b);
...
return cljs$core$async$impl$protocols$Buffer$close_buf_BANG_$dyn_43463(b);
}
});
