...
var shadow$remote$runtime$api$IRuntime$relay_msg$dyn_46572 = (function (runtime,msg){
...
return shadow$remote$runtime$api$IRuntime$relay_msg$dyn_46572(runtime,msg);
}
});

var shadow$remote$runtime$api$IRuntime$add_extension$dyn_46578 = (function (runtime,key,spec){
var x__4428__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IRuntime$add_extension$dyn_46578(runtime,key,spec);
}
});

var shadow$remote$runtime$api$IRuntime$del_extension$dyn_46582 = (function (runtime,key){
var x__4428__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IRuntime$del_extension$dyn_46582(runtime,key);
}
});
...
var shadow$remote$runtime$api$Inspectable$describe$dyn_46595 = (function (thing,opts){
...
return shadow$remote$runtime$api$Inspectable$describe$dyn_46595(thing,opts);
}
});
...
var shadow$remote$runtime$api$IEvalCLJS$_cljs_eval$dyn_46620 = (function (runtime,input,callback){
var x__4428__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IEvalCLJS$_cljs_eval$dyn_46620(runtime,input,callback);
}
});
...
var shadow$remote$runtime$api$IEvalJS$_js_eval$dyn_46630 = (function (runtime,code){
var x__4428__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IEvalJS$_js_eval$dyn_46630(runtime,code);
}
});


shadow.remote.runtime.api.cljs_eval = (function shadow$remote$runtime$api$cljs_eval(runtime,p__46555,callback){
...
var input = map__46557__$1;
var code = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__46557__$1,new cljs.core.Keyword(null,"code","code",1586293142));
var ns = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__46557__$1,new cljs.core.Keyword(null,"ns","ns",441598760));
