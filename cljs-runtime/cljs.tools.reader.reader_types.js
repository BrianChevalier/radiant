...
var cljs$tools$reader$reader_types$Reader$read_char$dyn_43984 = (function (reader){
...
return cljs$tools$reader$reader_types$Reader$read_char$dyn_43984(reader);
}
});

var cljs$tools$reader$reader_types$Reader$peek_char$dyn_43994 = (function (reader){
var x__4428__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$Reader$peek_char$dyn_43994(reader);
}
});
...
var cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_44002 = (function (reader,ch){
var x__4428__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_44002(reader,ch);
}
});
...
var cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_44007 = (function (reader){
var x__4428__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_44007(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_44009 = (function (reader){
var x__4428__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_44009(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_44013 = (function (reader){
var x__4428__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_44013(reader);
}
});
...
var G__44102 = rdr.cljs$tools$reader$reader_types$Reader$read_char$arity$1(null);
var G__44103 = s.append(c);
c = G__44102;
s = G__44103;
continue;
}
