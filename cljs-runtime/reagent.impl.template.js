...
var G__51399 = o;
goog.object.set(G__51399,reagent.impl.template.cached_prop_name(k),(reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
return (function() { 
var G__51605__delegate = function (args){
...
while (G__51609__i < G__51609__a.length) {G__51609__a[G__51609__i] = arguments[G__51609__i + 0]; ++G__51609__i;}
  args = new cljs.core.IndexedSeq(G__51609__a,0,null);
} 
return G__51605__delegate.call(this,args);};
G__51605.cljs$lang$maxFixedArity = 0;
G__51605.cljs$lang$applyTo = (function (arglist__51611){
var args = cljs.core.seq(arglist__51611);
return G__51605__delegate(args);
});
...
var G__51404 = o;
goog.object.set(G__51404,reagent.impl.template.cached_custom_prop_name(k),reagent.impl.template.convert_prop_value(v));
...
if(cljs.core.ifn_QMARK_(x)){
return (function() { 
var G__51615__delegate = function (args){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(x,args);
};
...
return G__51615__delegate.call(this,args);};
...
return G__51615__delegate(args);
});
...
var G__51413 = props;
var G__51413__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__51413,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__51413);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__51413__$1,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$2(class$,(function (){var or__4126__auto__ = new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props);
...
var props__$1 = reagent.impl.template.set_id_class((function (){var G__51423 = props;
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__51423,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$1(class$));
} else {
return G__51423;
}
})(),id_class);
...
var G__51427 = (cljs.core.count(argv) - first_child);
switch (G__51427) {
case (0):
...
var vec__51439 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__51439,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__51439,(1),null);
var className = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__51439,(2),null);
...
var temp__5739__auto___51655 = reagent.impl.util.react_key_from_vec(v);
if((temp__5739__auto___51655 == null)){
} else {
var key_51659 = temp__5739__auto___51655;
(jsprops.key = key_51659);
}
...
var temp__5739__auto___51662 = reagent.impl.util.react_key_from_vec(v);
if((temp__5739__auto___51662 == null)){
} else {
var key_51663 = temp__5739__auto___51662;
(jsprops.key = key_51663);
}
...
var temp__5739__auto___51677 = reagent.impl.util.react_key_from_vec(argv);
if((temp__5739__auto___51677 == null)){
} else {
var key_51684 = temp__5739__auto___51677;
(jsprops.key = key_51684);
}
...
var temp__5739__auto___51697 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5739__auto___51697 == null)){
} else {
var key_51698 = temp__5739__auto___51697;
(jsprops.key = key_51698);
}
...
var temp__5739__auto___51700 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5739__auto___51700 == null)){
} else {
var key_51701 = temp__5739__auto___51700;
(jsprops.key = key_51701);
}
...
return cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__51472_SHARP_){
return reagent.impl.protocols.as_element(compiler,p1__51472_SHARP_);
}),s));
});
...
var ctx = ({});
var vec__51482 = reagent.ratom.check_derefs((function (){
return reagent.impl.template.expand_seq_dev(x,ctx,compiler);
}));
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__51482,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__51482,(1),null);
...
break;
default:
var G__51729 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.with_meta(v,null),(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null),cljs.core.meta(v));
var G__51730 = compiler;
v = G__51729;
compiler = G__51730;
continue;
...
if((typeof reagent !== 'undefined') && (typeof reagent.impl !== 'undefined') && (typeof reagent.impl.template !== 'undefined') && (typeof reagent.impl.template.t_reagent$impl$template51534 !== 'undefined')){
} else {
...
*/
reagent.impl.template.t_reagent$impl$template51534 = (function (opts,id,fn_to_element,meta51535){
this.opts = opts;
this.id = id;
...
(reagent.impl.template.t_reagent$impl$template51534.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_51536,meta51535__$1){
var self__ = this;
var _51536__$1 = this;
return (new reagent.impl.template.t_reagent$impl$template51534(self__.opts,self__.id,self__.fn_to_element,meta51535__$1));
}));

(reagent.impl.template.t_reagent$impl$template51534.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_51536){
var self__ = this;
var _51536__$1 = this;
return self__.meta51535;
}));

(reagent.impl.template.t_reagent$impl$template51534.prototype.reagent$impl$protocols$Compiler$ = cljs.core.PROTOCOL_SENTINEL);

(reagent.impl.template.t_reagent$impl$template51534.prototype.reagent$impl$protocols$Compiler$get_id$arity$1 = (function (this$){
var self__ = this;
var this$__$1 = this;
return self__.id;
}));

(reagent.impl.template.t_reagent$impl$template51534.prototype.reagent$impl$protocols$Compiler$as_element$arity$2 = (function (this$,x){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.as_element(this$__$1,x,self__.fn_to_element);
}));

(reagent.impl.template.t_reagent$impl$template51534.prototype.reagent$impl$protocols$Compiler$make_element$arity$5 = (function (this$,argv,component,jsprops,first_child){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.make_element(this$__$1,argv,component,jsprops,first_child);
}));

(reagent.impl.template.t_reagent$impl$template51534.getBasis = (function (){
return new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"opts","opts",1795607228,null),new cljs.core.Symbol(null,"id","id",252129435,null),new cljs.core.Symbol(null,"fn-to-element","fn-to-element",-1764467095,null),new cljs.core.Symbol(null,"meta51535","meta51535",1638937878,null)], null);
}));

(reagent.impl.template.t_reagent$impl$template51534.cljs$lang$type = true);

(reagent.impl.template.t_reagent$impl$template51534.cljs$lang$ctorStr = "reagent.impl.template/t_reagent$impl$template51534");

(reagent.impl.template.t_reagent$impl$template51534.cljs$lang$ctorPrWriter = (function (this__4369__auto__,writer__4370__auto__,opt__4371__auto__){
return cljs.core._write(writer__4370__auto__,"reagent.impl.template/t_reagent$impl$template51534");
}));

/**
 * Positional factory function for reagent.impl.template/t_reagent$impl$template51534.
 */
reagent.impl.template.__GT_t_reagent$impl$template51534 = (function reagent$impl$template$create_compiler_$___GT_t_reagent$impl$template51534(opts__$1,id__$1,fn_to_element__$1,meta51535){
return (new reagent.impl.template.t_reagent$impl$template51534(opts__$1,id__$1,fn_to_element__$1,meta51535));
});

}

return (new reagent.impl.template.t_reagent$impl$template51534(opts,id,fn_to_element,cljs.core.PersistentArrayMap.EMPTY));
});
